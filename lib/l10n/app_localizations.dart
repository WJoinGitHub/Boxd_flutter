...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'view_all': 'View all',
      'not_scanned_equipment': 'Not scanned my equipment',
      'ai_message_how_to_work': 'Ai message how to work',
      'device_connect_failed': 'Device connect failed',
      'bluetooth_connection_issues': 'Bluetooth Connection Issues',
      ...
      'password_requirements': 'Password must be 6-20 characters',
    ...
    'zh': {
      ...
      'top_questions': '常见问题',
      'view_all': '查看全部',
      'not_scanned_equipment': '未扫描到设备',
      'ai_message_how_to_work': 'AI消息如何使用',
      'device_connect_failed': '设备连接失败',
      'bluetooth_connection_issues': '蓝牙连接问题',
      'scheduled_heating_issues': '定时加热问题',
      ...
      'bluetooth_turned_off_desc': '您手机的蓝牙已关闭，请打开它。',
      'open_settings': '打开设置',
      'enable_bluetooth_permission': '请启用蓝牙权限',
      'bluetooth_permission_desc': 'MEDCURSOR需要权限来访问蓝牙配对硬件。',
      'grant_permission': '授予权限',
      'turn_on_location': '请打开位置服务',
      'location_desc': '用于查找附近的蓝牙设备。',
      'turn_on': '打开',
      'connect': '连接',
      'connect_failed': '连接失败。',
      'connect_failed_desc': '请尝试重启手机的蓝牙或关闭设备电源然后重新打开。',
      'connecting': '连接中...',
      ...
      'password_requirements': '密码需要6-20个字符',
      ...
      'six_to_twenty_characters': '6到20个字符',
      'letters_numbers_special_characters': '字母、数字和特殊字符',
      'password_requirements_detail': '密码要求：6-20个字符',
      'username_label': '用户名',
