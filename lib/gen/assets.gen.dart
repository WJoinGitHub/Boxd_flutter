...
class $AssetsLaunchGen {
  ...
  /// Directory path: assets/launch/images
  $AssetsLaunchImagesGen get images => const $AssetsLaunchImagesGen();
}
...
class $AssetsDeviceImagesGen {
  ...
  /// File path: assets/device/images/dev_open_location.png
  AssetGenImage get devOpenLocation => const AssetGenImage('assets/device/images/dev_open_location.png');
...
class $AssetsHomeImagesGen {
  ...
  /// File path: assets/home/images/add_device_big.png
  AssetGenImage get addDeviceBig => const AssetGenImage('assets/home/images/add_device_big.png');
...
class $AssetsLaunchImagesGen {
  const $AssetsLaunchImagesGen();

  /// File path: assets/launch/images/wel_launch.png
  AssetGenImage get welLaunch => const AssetGenImage('assets/launch/images/wel_launch.png');

  /// List of all assets
  List<AssetGenImage> get values => [welLaunch];
}

class $AssetsLoginImagesGen {
  const $AssetsLoginImagesGen();

  /// File path: assets/login/images/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/login/images/logo.png');
