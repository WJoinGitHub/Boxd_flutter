# Umeng + Huawei Push (com.huawei.hms:push): HMS references optional Huawei / HiAnalytics /
# BouncyCastle types that are absent on a generic classpath. R8 reports them as missing
# unless suppressed (see build/app/outputs/mapping/release/missing_rules.txt after a failed build).
