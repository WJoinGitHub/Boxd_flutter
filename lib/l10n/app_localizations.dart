...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'remind': 'Remind',
      'device_not_connected': 'Device not connected. Please connect your device first.',
      ...
      'heating_duration_too_long': 'Heating duration too long, cannot finish before set time',
    },
    'zh': {
      // Common
      'cancel': '取消',
